...
Используется для горизонтального и вертикального выравнивания элементов.

div class="d-flex justify-content-between align-items-center mb-3"

d-flex → включает Flexbox для контейнера.

justify-content-between → распределяет элементы по горизонтали с равными промежутками между ними.

align-items-center → выравнивает элементы по вертикали по центру.

mb-3 → добавляет нижний отступ (margin-bottom: 1rem).

Пример использования: заголовок + кнопка «Создать объявление» на одной строке, с кнопкой справа.

2. Выравнивание текста
div class="text-center".../div


text-center → центрирует текст по горизонтали внутри контейнера.
Пример: заголовок и подзаголовок в герое (<header>).

3. Выравнивание в колонках
div class="row g-2 align-items-end".../div


row → создаёт горизонтальный ряд для колонок (col-*).

g-2 → задаёт промежуток между колонками (gap).

align-items-end → выравнивает элементы в колонках по нижнему краю.

Пример: форма фильтров на главной странице.
...
col-md-* → задаёт ширину колонки на средних экранах и выше.

Вместе с row создаёт сетки для выравнивания форм и карточек.

5. Выравнивание кнопок
